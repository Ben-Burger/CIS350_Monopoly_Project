...
//	private int[] playernumonproperty = new int[40];	// is this not used??
	...
	private void placePiece(final PropertyPiecePlacement property, final int playernum) {
		if (matrix[property.getNoPieceRow()][property.getNoPieceCol()].getText().contentEquals("")) {
			matrix[property.getNoPieceRow()][property.getNoPieceCol()].setForeground(playerColor(playernum));
			matrix[property.getNoPieceRow()][property.getNoPieceCol()].setText("" + playernum);
		} else if (matrix[property.getOnePieceRow()][property.getOnePieceCol()].getText().contentEquals("")) {
			matrix[property.getOnePieceRow()][property.getOnePieceCol()].setForeground(playerColor(playernum));
			matrix[property.getOnePieceRow()][property.getOnePieceCol()].setText("" + playernum);
		} else if (matrix[property.getTwoPieceRow()][property.getTwoPieceCol()].getText().contentEquals("")) {
			matrix[property.getTwoPieceRow()][property.getTwoPieceCol()].setForeground(playerColor(playernum));
			matrix[property.getTwoPieceRow()][property.getTwoPieceCol()].setText("" + playernum);
		} else {
			matrix[property.getThreePieceRow()][property.getThreePieceCol()].setForeground(playerColor(playernum));
			matrix[property.getThreePieceRow()][property.getThreePieceCol()].setText("" + playernum);
		}
	}
	...
	private void removePiece(final PropertyPiecePlacement property, final int playernum) {
		if (matrix[property.getNoPieceRow()][property.getNoPieceCol()].getText().contentEquals("" + playernum)) {
			matrix[property.getNoPieceRow()][property.getNoPieceCol()].setText("");
		} else if (matrix[property.getOnePieceRow()][property.getOnePieceCol()].getText().contentEquals("" + playernum)) {
			matrix[property.getOnePieceRow()][property.getOnePieceCol()].setText("");
		} else if (matrix[property.getTwoPieceRow()][property.getTwoPieceCol()].getText().contentEquals("" + playernum)) {
			matrix[property.getTwoPieceRow()][property.getTwoPieceCol()].setText("");
		} else {
			matrix[property.getThreePieceRow()][property.getThreePieceCol()].setText("");
		}
	}
